    ...
    <div class="row">
        ...
        <div class="col-6 col-md">
            ...
            <ul class="list-unstyled text-small">
                <li><a class="text-muted" href="#">Abdelrahman yasser</a></li>
            </ul>
        </div>
        <div class="col-6 col-md">
            <h5>Information</h5>
            <ul class="list-unstyled text-small">
                <li><a class="text-muted" href="#">Graduated from MSA Universty</a></li>
        ...
        <div class="col-6 col-md">
            ...
            <ul class="list-unstyled text-small">
                <li><a class="text-muted" href="#">Php storm</a></li>
                <li><a class="text-muted" href="#">Xamp</a></li>
